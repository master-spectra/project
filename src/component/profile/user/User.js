...
export const User = ({currentProfile, updateStatus}) => {
    ...
    return currentProfile ? <div className={UserStyle.profileWrap}>
                ...
                <div className={UserStyle.user}>
                    <img className={UserStyle.imgUser}
                         src={currentProfile.photos && currentProfile.photos.small ? currentProfile.photos.small : Logo}
                         alt={"#"}/>
